...
int main(int argc, char** argv) {
    ...
    nob_sb_appendf(&sb, "#define __RASEN_VERSION__ \"%s\"\n", APP_VERSION);
    nob_sb_appendf(&sb, "#define __GIT_REPO__ \"%s\"\n", "https://github.com/SolarisStudio/rasen.git");
    ...
    nob_cmd_append(&cmd, "src/Application.cpp");
    nob_cmd_append(&cmd, "src/Button.cpp");
    nob_cmd_append(&cmd, "src/CheckBox.cpp");
    nob_cmd_append(&cmd, "src/ComboBox.cpp");
    nob_cmd_append(&cmd, "src/Container.cpp");
    nob_cmd_append(&cmd, "src/Label.cpp");
    nob_cmd_append(&cmd, "src/Panel.cpp");
    nob_cmd_append(&cmd, "src/Slider.cpp");
    nob_cmd_append(&cmd, "src/Widget.cpp");
    nob_cmd_append(&cmd, "src/Window.cpp");
